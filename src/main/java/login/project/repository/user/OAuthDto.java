...
public class OAuthDto {
    ...
    //OAuth 서버에서 넘어온 사용자 정보들을 담을 Dto
    ...
    private static OAuthDto ofKakao(String attributeKey, Map<String, Object> attributes) {
    ...
    private static OAuthDto ofNaver(String attributeKey, Map<String, Object> attributes) {
